...
anders angemerkt, wird sich auf eine Drehung um 90° im Uhrzeigersinn bezogen.

\begin{itemize}
  \item \emph{F}ront bzw. Vorderseite
  \item \emph{R}ight bzw. rechte Seite
  \item \emph{B}ack bzw Rückseite
  \item \emph{L}eft bzw. linke Seite
  \item \emph{D}own bzw. Unterseite
  \item \emph{U}p bzw. Oberseite
  \item ein nachgestelltes Hochkomma \' ändert die Rotationsrichtung gegen den
    Uhrzeigersinn
  \item eine nachgestellte \emph{2} führt die Drehung zweimal, also um 180° aus
\end{itemize}

Die Kombination \emph{F2 B R' L} bedeutet also:
\begin{itemize}
  \item Drehe die Vorderseite um 180°
  \item Drehe die Rückseite um 90° im Uhrzeigersinn
  \item Drehe die rechte Seite 90° gegen den Uhrzeigersinn
  \item Drehe die linke Seite um 90° im Uhrzeigersinn
\end{itemize}
