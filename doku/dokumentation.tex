...
Die Branching-Struktur folgt in einer vereinfachten Form dem Vorschlag von
...
Der Würfel an sich besteht aus mehreren Komponenten, dem \texttt{Rotator}, dem \texttt{CubeUpdater}
...
%Das Lösen wird, wie bereits erwähnt, durch eine Bibliothek bereitgestellt, die den
%\emph{Two-Phase}-Algorithmus implementiert. 
